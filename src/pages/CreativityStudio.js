...
const CreativityStudio = () => {
  ...
  return (
    <div
      ...
      style={{
        textAlign: "center",
        padding: "120px 50px 50px 50px", // top padding increased
    ...
    >
      ...
      {selectedImage && (
        ...
        >
          ...
          {/* Buttons */}
          <button onClick={eraseMode} style={buttonStyle}>Eraser</button>
          <button onClick={clearCanvas} style={buttonStyle}>Clear</button>
          <button onClick={downloadDrawing} style={buttonStyle}>Download</button>
        </div>
      )}
